...
import com.softvalley.hotelpos.databinding.CustomProductDialogSaleReturnBinding;
import com.softvalley.hotelpos.databinding.FragmentSaleDocReturnBinding;
...
import com.softvalley.hotelpos.views.sale.viewModel.SaleReturnDocViewModel;
            ...
            public void onChanged(Integer action) {
                ...
                if (action == 2) {
                    SaleReturnDocFragmentDirections.ActionSaleReturnDocFragmentToSaleDocListFragment navAction =
                            SaleReturnDocFragmentDirections.actionSaleReturnDocFragmentToSaleDocListFragment("Sale Return Doc List");
