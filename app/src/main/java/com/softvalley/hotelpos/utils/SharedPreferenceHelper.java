...
public class SharedPreferenceHelper {
    ...
    public boolean getIsReserved(String tableCode)
    {

        return sharedPreferences.getBoolean(tableCode, false);
    }

    public void setIsReserved(String tableCode,boolean isReserved)
    {
        sharedPreferences.edit().putBoolean(tableCode, isReserved).apply();
    }


    public int getNumberOfGuestByTable(String tableCode)
    {

        int value=sharedPreferences.getInt(tableCode,0);
        return value ;
    }

    public void setGuestByTable(String tableCode,int guestNumber)
    {
        sharedPreferences.edit().putInt(tableCode, guestNumber).apply();
    }
